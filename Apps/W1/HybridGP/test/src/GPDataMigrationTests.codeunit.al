...
#pragma warning restore AA0240
    ...
    begin
        ...
        // [THEN] The default Receivables account will be used for transactions when an account or class is not configured
        Clear(GenJournalLine);
        GenJournalLine.SetRange("Account Type", "Gen. Journal Account Type"::Customer);
        GenJournalLine.SetRange("Account No.", '#1');
        Assert.IsTrue(GenJournalLine.FindFirst(), 'Could not locate Gen. Journal Line.');
        Assert.AreEqual('100', GenJournalLine."Bal. Account No.", 'Incorrect Bal. Account No. on Gen. Journal Line.');
    end;
    ...
    begin
        ...
        // [THEN] The default Payables account will be used for transactions when an account or class is not configured
        Clear(GenJournalLine);
        GenJournalLine.SetRange("Account Type", "Gen. Journal Account Type"::Vendor);
