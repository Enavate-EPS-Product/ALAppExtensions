codeunit 42000 "GP Vendor 1099 Mig. Install"
{
    ...
    begin
        ...
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 4, 7, 'MISC-07');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 4, 8, 'MISC-08');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 4, 9, 'MISC-09');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 4, 10, 'MISC-10');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 4, 11, 'MISC-11');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 4, 12, 'MISC-12');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 4, 13, 'MISC-14');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 4, 14, 'MISC-15');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 4, 15, 'MISC-16');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 5, 1, 'NEC-01');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 5, 2, 'NEC-02');
        GPVendor1099MappingHelpers.InsertMapping(TaxYear, 5, 3, 'NEC-04');
    end;
}