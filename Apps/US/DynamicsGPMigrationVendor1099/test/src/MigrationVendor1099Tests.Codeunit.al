codeunit 139701 "Migration Vendor 1099 Tests"
{
    ...
    begin
        ...
        Assert.AreEqual('MISC-07', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 4, 7), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('MISC-08', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 4, 8), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('MISC-09', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 4, 9), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('MISC-10', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 4, 10), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('MISC-11', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 4, 11), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('MISC-12', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 4, 12), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('MISC-14', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 4, 13), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('MISC-15', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 4, 14), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('MISC-16', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 4, 15), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('NEC-01', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 5, 1), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('NEC-02', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 5, 2), 'Incorrect 1099 Box Code returned.');
        Assert.AreEqual('NEC-04', GPVendor1099MappingHelpers.GetIRS1099BoxCode(2022, 5, 3), 'Incorrect 1099 Box Code returned.');
    end;
    ...
    begin
        ...
        // [WHEN] Staging data exists
        GPPopulateVendor1099Data.GetVendorLatest1099Period(TestVendorNoLbl, LastReportedYear, LastReportedPeriodOfYear);

        // [THEN] The GetVendorLatest1099Period procedure will return correct values
        Assert.AreEqual(2022, LastReportedYear, 'LastReportedYear is incorrect.');
        Assert.AreEqual(4, LastReportedPeriodOfYear, 'LastReportedPeriodOfYear is incorrect.');
        ...
        Assert.AreEqual(-100, VendorLedgerEntry."IRS 1099 Amount", 'Invoice Vendor ledger entry IRS 1099 Amount is incorrect.');
        Assert.AreEqual('NEC-01', VendorLedgerEntry.Description, 'Invoice Vendor ledger entry description is incorrect.');
        ...
        Assert.AreEqual(100, DetailedVendorLedgEntry."Credit Amount", 'Applied Payment Detailed Vendor ledger entry Credit Amount is incorrect.');

        // NEC-02, $200
        VendorLedgerEntry.SetRange("Vendor No.", TestVendorNoLbl);
        VendorLedgerEntry.SetRange("Document Type", VendorLedgerEntry."Document Type"::Invoice);
        VendorLedgerEntry.SetRange(Description, 'NEC-02');
        Assert.IsTrue(VendorLedgerEntry.FindFirst(), 'NEC-02 Vendor ledger entry not found.');
        DocumentNo := VendorLedgerEntry."Document No.";
